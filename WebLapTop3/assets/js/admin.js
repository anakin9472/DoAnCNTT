...
function buildAccountsTable(data) 
{
  ...
  for (var i = 0; i < data.length; i++)
  {
    ...
    userid = data[i].id
    console.log(userid)
    var $button = "<button onclick='viewDetails(this)'>" +"XEM" + "</button>";
    var $button2 = "<button onclick='deleteAccount(this)'>" +"XÓA" + "</button>";
