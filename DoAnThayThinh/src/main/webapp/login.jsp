                                    ...
                                    <div class="contact-box footer-block-contant">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="contact-box-detail">
                                                    <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9ce4ecf3fbf9dcf4f5adaeafb2fff3f1">[email&#160;protected]</a></p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
     ...
     <script>
         Validator({
             ...
             rules:[
                 ...
                 //login-form
                 Validator.isRequired('#login-email','Please enter your email!'),
                 Validator.isEmail('#login-email','This must be an email!'),
                 Validator.isRequired('#login-pass','Please enter your password!'),
             ]
             ,
