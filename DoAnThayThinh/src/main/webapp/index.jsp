    ...
    <div class="main">
                                                ...
                                                <ul class="sub-menu-level1">
                                                    ...
                                                    <li class="level2 d-none d-lg-block">
                                                        <a href="shop.html" class="m-0">
							                        		<img src="template/images/drop_banner3.jpg" alt="Xpoge">
							                        	</a>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 mt-30 d-none d-lg-block">
                                                        <div class="sub-menu-img">
                                                            <a href="shop.html">
							                      				<img src="template/images/drop_banner1.jpg" alt="Xpoge">
							                      			</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 mt-30 d-none d-lg-block">
                                                        <div class="sub-menu-img">
                                                            <a href="shop.html">
							                      				<img src="template/images/drop_banner2.jpg" alt="Xpoge">
							                      			</a>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <section id="banner-part" class="menu-section pb-100">
            <div class="banner main-banner owl-carousel">
                ...
                <div class="banner-2">
                    <img src="template/images/banner2.jpg" alt="Xpoge">
                    <div class="banner-detail">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="sub-banner-box">
                            <a href="shop.html">
	        						<img class="d-none d-md-block" src="template/images/sub-banner1.jpg" alt="Xpoge">
	        						<img class="d-block d-md-none" src="template//sub-responsive-banner1.jpg" alt="Xpoge">
	        					</a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="sub-banner-box">
                                    <a href="shop.html">
			        						<img class="d-none d-md-block" src="template/images/sub-banner2.jpg" alt="Xpoge">
			        						<img class="d-block d-md-none" src="template/images/sub-responsive-banner2.jpg" alt="Xpoge">
			        					</a>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="sub-banner-box">
                                    <a href="shop.html">
			        						<img class="d-none d-md-block" src="template/images/sub-banner3.jpg" alt="Xpoge">
			        						<img class="d-block d-md-none" src="template/images/sub-responsive-banner3.jpg" alt="Xpoge">
			        					</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="sub-banner-box">
                                    <a href="shop.html">
			        						<img class="d-none d-md-block" src="template/images/sub-banner4.jpg" alt="Xpoge">
			        						<img class="d-block d-md-none" src="template/images/sub-responsive-banner4.jpg" alt="Xpoge">
			        					</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="services-box mb-30">
                                <div class="services-box-inner">
                                    <div class="services-icon services1">
                                        <img src="template/images/ser-icon1.svg" alt="xpoge">
                                    </div>
                            ...
                            <div class="services-box mb-30">
                                <div class="services-box-inner">
                                    <div class="services-icon services2">
                                        <img src="template/images/ser-icon2.svg" alt="xpoge">
                                    </div>
                                    <div class="services-detail">
                ...
                <div class="row">
                        ...
                        <div class="product-item">
                            <div class="product-image">
                                ...
                                <a href="product-page.html">
		                				<img src="template/images/1.jpg" alt="Xpoge">
		                			</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="product-item">
                            <div class="product-image">
                                <a href="product-page.html">
		                				<img src="template/images/2.jpg" alt="Xpoge">
		                			</a>
                            </div>
                            <div class="product-details-outer">
                                <div class="product-details">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="product-item">
                            <div class="product-image">
                                ...
                                <a href="product-page.html">
		                				<img src="template/images/3.jpg" alt="Xpoge">
		                			</a>
                            </div>
                            <div class="product-details-outer">
                                <div class="product-details">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="product-item">
                            <div class="product-image">
                                <a href="product-page.html">
		                				<img src="template/images/5.jpg" alt="Xpoge">
		                			</a>
                            </div>
                            <div class="product-details-outer">
                                <div class="product-details">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="product-item">
                            <div class="product-image">
                                ...
                                <div class="new-label"><span>New</span></div>
                                <a href="product-page.html">
		                				<img src="template/images/6.jpg" alt="Xpoge">
		                			</a>
                            </div>
                            <div class="product-details-outer">
                                <div class="product-details">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="product-item">
                            <div class="product-image">
                                <a href="product-page.html">
		                				<img src="template/images/7.jpg" alt="Xpoge">
		                			</a>
                            </div>
                            <div class="product-details-outer">
                                <div class="product-details">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="product-item">
                            <div class="product-image">
                                <a href="product-page.html">
		                				<img src="template/images/8.jpg" alt="Xpoge">
		                			</a>
                            </div>
                            <div class="product-details-outer">
                                <div class="product-details">
            ...
            <div class="container">
                ...
                <div class="testimonial-slider owl-carousel position-initial">
                    <div class="item testimonial-main">
                        <div class="client-img-main">
                            <div class="client-img">
                                <img alt="Xpoge" src="template/images/testimonial_img1.jpg">
                            </div>
                            <div class="quote-img">
                                <img src="template/images/quote-img.png" alt="Xpoge">
                            </div>
                        </div>
                    ...
                    <div class="item testimonial-main">
                        <div class="client-img-main">
                            <div class="client-img">
                                <img alt="Xpoge" src="template/images/testimonial_img2.jpg">
                            </div>
                            <div class="quote-img">
                                <img src="template/images/quote-img.png" alt="Xpoge">
                            </div>
                    ...
                    <div class="item testimonial-main">
                        <div class="client-img-main">
                            <div class="client-img">
                                <img alt="Xpoge" src="template/images/testimonial_img3.jpg">
                            </div>
                            <div class="quote-img">
                                <img src="template/images/quote-img.png" alt="Xpoge">
                            </div>
                        ...
                        <div class="product-slider owl-carousel position-initial">
                            ...
                            <div class="item">
                                <div class="product-item">
                                    <div class="product-image">
                                        <a href="product-page.html">
				                				<img src="template/images/4.jpg" alt="Xpoge">
				                			</a>
                                    </div>
                                    <div class="product-details-outer">
                                        <div class="product-details">
                ...
                <div class="brand-part-inner">
                    <div class="row">
                        <div class="brand-slider owl-carousel">
                            <div class="item">
                                <img src="template/images/brand-img1.png" alt="brand-img">
                            </div>
                            <div class="item">
                                <img src="template/images/brand-img2.png" alt="brand-img">
                            </div>
                            <div class="item">
                                <img src="template/images/brand-img3.png" alt="brand-img">
                            </div>
                            <div class="item">
                                <img src="template/images/brand-img4.png" alt="brand-img">
                            </div>
                            <div class="item">
                                <img src="template/images/brand-img5.png" alt="brand-img">
                            </div>
                            <div class="item">
                                <img src="template/images/brand-img6.png" alt="brand-img">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="blog-item first-blog">
                                <div class="blog-image">
                                    <a href="blog-detail.html">
            								<img src="template/images/blog-img1.jpg" alt="Xpoge">
            							</a>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="blog-item">
                                        <div class="blog-image">
                                            <a href="blog-detail.html">
		                							<img src="template/images/blog-img2.jpg" alt="Xpoge">
		                						</a>
                                        </div>
                                        <div class="blog-detail">
                                            <span class="bloger-date">John Doe (05 Jan 2020)</span>
                                ...
                                <div class="col-12">
                                    <div class="blog-item">
                                        <div class="blog-image">
                                            <a href="blog-detail.html">
	                								<img src="template/images/blog-img3.jpg" alt="Xpoge">
	                							</a>
                                        </div>
                                        <div class="blog-detail">
                                            <span class="bloger-date">John Doe (05 Jan 2020)</span>
                                    ...
                                    <div class="contact-box footer-block-contant">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="contact-box-detail">
                                                    <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e39b938c8486a38b8ad2d1d0cd808c8e">[email&#160;protected]</a></p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
